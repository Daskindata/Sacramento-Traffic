...
#Linear regression of the reduced model
parked <- trainingData[, -c(1,2,3, 4, 6,7,8,9,10,12, 14,16,17,18,19,20,21,22,23,24)]
lmMod2 <- lm(is_double_parked ~., parked, na.action = na.omit)  # the linear reg model
